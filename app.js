...
const regions = [
  {
    ...
    gyms: [
      ...
      },
      {
        ...
        type: "Normal",
        tone: "neutral",
        steps: ["Equipo: Typhlosion en slot 2 + Blastoise W", "CURAR antes de entrar", "Cambiar Blastoise W -> Gafas Elegidas"],
        moves: [],
        after: [],
      },
      {
      ...
      },
      {
        ...
        type: "Acero",
        tone: "neutral",
        steps: ["Equipo: Weezing variable + Typhlosion", "T1 -> Dia Soleado", "T2 contra Metagross -> Golpe Bajo", "Resto -> Golpe Bajo"],
        moves: [],
    ...
    gyms: [
      {
        ...
        type: "Lucha",
        tone: "amber",
        steps: ["CURAR", "Equipo: Blastoise W + Togekiss"],
        moves: [],
        after: [],
      },
      {
        ...
        type: "Roca",
        tone: "red",
        steps: ["Equipo: Weezing + Blastoise W", "Usar Golpe Bajo"],
        moves: [],
      ...
      },
      {
        ...
        steps: [
          "CURAR",
          "Inicio: Weezing + Hydreigon",
          "Surf contra Stantler, Spinda, Blissey y Chansey",
          "Contra Blissey -> Typhlosion + Togekiss con Psicocarga",
          "Contra Spinda T4 -> Vanilluxe + Togekiss",
        ],
        moves: [],
      ...
      },
      {
        ...
        type: "Volador",
        tone: "violet",
        steps: ["CURAR", "Inicio: Weezing + Hydreigon", "Cambiar a: Typhlosion + Togekiss"],
        moves: [
  ...
  },
  {
    ...
    gyms: [
      ...
      },
      {
        ...
        type: "Roca",
        tone: "red",
        steps: ["CURAR", "Inicio: Weezing + Hydreigon", "Contra Excadrill -> Typhlosion + Togekiss", "Resto -> Togekiss + Blastoise W"],
        moves: [],
        after: [{ kind: "item", text: "Blastoise W -> Gafas Elegidas" }],
      },
      {
        ...
        steps: [
          "CURAR",
          "Inicio: Weezing + Hydreigon",
          "Contra Pelipper -> Togekiss + Blastoise W",
          "Contra Gigalith + Aron -> Typhlosion + Togekiss",
          "Contra Bastiodon -> Vanilluxe + Blastoise W",
        ],
        moves: [],
      ...
      },
      {
        ...
        type: "Lucha",
        tone: "amber",
        steps: ["CURAR", "Equipo: Weezing + Hydreigon", "Contra Lucario o Wobbuffet -> Surf", "Resto -> Viento Afin -> Typhlosion + Togekiss"],
        moves: [],
    ...
    gyms: [
      {
        ...
        type: "Electrico",
        tone: "amber",
        steps: ["Curar si hay dano", "Equipo: Typhlosion + Togekiss", "Si hay lluvia -> Rapidez"],
        moves: [],
        after: [],
      },
      {
        ...
        type: "Fuego",
        tone: "red",
        steps: ["CURAR", "Inicio: Weezing + Hydreigon", "Cambiar a: Togekiss + Blastoise W"],
        moves: [
      ...
      },
      {
        ...
        type: "Roca",
        tone: "red",
        steps: ["CURAR", "Inicio: Weezing + Hydreigon", "Cambiar a: Togekiss + Blastoise W", "Psicocarga contra Sandslash o Chansey"],
        moves: [],
      ...
      },
      {
        ...
        type: "Veneno",
        tone: "violet",
        steps: ["Equipo: Typhlosion en slot 1 + Togekiss", "Contra Tentacruel -> Psiquico", "Contra Nidoqueen -> Senal Luminosa", "Resto -> Vozarron"],
        moves: [],
        after: [
  ...
  },
  {
    ...
    gyms: [
      ...
      },
      {
        ...
        type: "Roca",
        tone: "red",
        steps: ["Equipo: Weezing + Blastoise W", "Usar Golpe Bajo", "Usar Water Spout con Blastoise W", "Si Weezing cae -> entrar Vanilluxe"],
        moves: [],
      ...
      },
      {
        ...
        type: "Volador",
        tone: "violet",
        steps: ["CURAR", "Equipo: Blastoise W + Vanilluxe", "Si sale Unfezant: T1 -> Weezing, T2 -> Golpe Bajo, T3 -> Golpe Bajo"],
        moves: [],
        after: [
          { kind: "item", text: "Togekiss -> Gafas Elegidas" },
      ...
      },
      {
        ...
        type: "Dragon",
        tone: "green",
        steps: ["Inicio: Weezing + Hydreigon", "Contra Hydreigon enemigo -> Typhlosion + Togekiss", "Resto -> Vanilluxe + Togekiss"],
        moves: [],
        after: [{ kind: "item", text: "Blastoise W -> Gafas Elegidas" }],
      },
      {
        ...
        steps: [
          "CURAR",
          "Gym de Fuego -> Togekiss + Blastoise W",
          "Gym de Planta -> Typhlosion + Togekiss",
          "Gym de Agua -> Typhlosion + Togekiss",
          "Estrategia: Refuerzo + Vozarron. Si cae un Pokemon -> entra Weezing",
        ],
        moves: [],
        after: [],
      },

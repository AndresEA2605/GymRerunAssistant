...
export const guide2Steps: RouteStep[] = [
  ...
  // ═══════════════════════════════════════
  {
    ...
    actions: ["Togekiss → Hyper Voice", "Typhlosion → Eruption"],
  },
  // Vs Ninetales — Swap Typhlosion → Vanilluxe
  {
    ...
    switchTo: ["Vanilluxe"],
    actions: ["Typhlosion → Eruption (antes del cambio)", "Typhlosion → Vanilluxe (Cambio)", "Togekiss → Hyper Voice"],
  },
  {
  ...
  // Vs Tyranitar + Excadrill — 2 turns
  {
    ...
    actions: ["Aerodactyl → Protect", "Excadrill → Earthquake"],
  },
  {
  ...
  // Vs Lanturn — Swap Blastoise → Vanilluxe
  {
    ...
    description: "Cambio: Blastoise → Vanilluxe. Vanilluxe ataca con Blizzard o Icy Wind.",
  },
  {
  ...
  // Vs Ninetales / Torkoal — Swap Aerodactyl → Vanilluxe
  {
    ...
    switchTo: ["Vanilluxe"],
    actions: ["Aerodactyl → Vanilluxe (Cambio)", "Blastoise → Water Spout"],
  },
  {
  ...
  // ═══════════════════════════════════════
  {
    ...
    actions: ["Vanilluxe → Blizzard", "Blastoise → Water Spout"],
  },
  {
  ...
  },
  {
    ...
    actions: ["Togekiss → Hyper Voice", "Excadrill → Earthquake"],
  },
  ...
  // Vs Stoutland + Gyarados
  {
    ...
    actions: ["Usar X-Special", "Togekiss → Hyper Voice"],
  },
  {
  ...
  },
  {
    ...
    actions: ["Vanilluxe → Blizzard", "Typhlosion → Eruption"],
  },
  {
    id: 38, type: "gym", region: "Unova", gym: "Fayenza",
    title: "Icirrus City (Ice)", lead: G2_LEAD["Icirrus City (Ice)"],
    actions: ["Aerodactyl → Sunny Day", "Typhlosion → Eruption"],
  },
  {
  ...
  // Vs Pidgeot
  {
    ...
    actions: ["Usar X-Speed", "Vanilluxe → Blizzard"],
  },
  {
  ...
  },
  {
    ...
    actions: ["Excadrill → Earthquake", "Togekiss → Hyper Voice"],
  },
  // Vs Dodrio
  {
  ...
  // Vs Corsola + Blastoise — Swap Typhlosion → Blastoise
  {
    ...
    switchTo: ["Blastoise"],
    actions: ["Togekiss → Hyper Voice", "Typhlosion → Blastoise (Cambio)"],
  },
  {
  ...
  },
  {
    ...
    actions: ["Togekiss → Air Cutter", "Excadrill → Earthquake"],
  },
